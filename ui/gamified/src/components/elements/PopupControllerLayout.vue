...
<template>
<div :id='id'>
    <button type='button' class='button-toolbar button-secondary' :id='id + "-button"' @blur='closeHelp' @click='openHelp' aria-label="popup controller layout" data-bs-toggle="tooltip" title="Controller layout">
