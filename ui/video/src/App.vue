       ...
       <navigation-bar />
        ...
        <!-- first-row etc only exist as styles when large screen -->
            <div :class="isMobile ? '' : 'd-flex'" id='first-row'>
              <div :class="isMobile ? 'drop-area drop-area-mobile' : 'drop-area drop-area-full'" id='drop_0_0' :draggable='getDraggable' @dragstart="dragComponent" @drop='dropComponent' @dragover.prevent @dragenter='dragEnter' @dragleave="dragLeave"><webcam-stream id='webcam-stream' /></div>
            </div>
